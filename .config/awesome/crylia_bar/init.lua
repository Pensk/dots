...
-- e.g. 1 would be the primary screen and 2 the secondary screen.
  ...
  if s.index == 1 then
    ...
    require("crylia_bar.right_bar")(s, { s.ram_info, s.gpu_usage, s.cpu_usage, s.kblayout, s.date, s.clock, s.powerbutton })
  ...
  if s.index == 2 then
    ...
    -- require("crylia_bar.center_bar")(s, { s.tasklist })
    require("crylia_bar.right_bar")(s, { s.date, s.clock})
  end
  ...
  if s.index == 3 then
    ...
    require("crylia_bar.left_bar")(s, { s.layoutlist, s.taglist })
    require("crylia_bar.center_bar")(s, { s.tasklist })
    require("crylia_bar.right_bar")(s, { s.ram_info, s.gpu_usage, s.cpu_usage, s.kblayout, s.network, s.date, s.clock, s.powerbutton })
  end
end
)
