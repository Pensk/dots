...
local papers = {}
local p = io.popen('find "' .. home .. '/proj/backs" -maxdepth 1 -type f')
for f in p:lines() do
...
user_vars = {
  ...
  -- "alacritty -tag 1",
  -- "steam -tag 2 -floating",
  -- "Discord -tag 1 -screen 3",
  -- "firefox -tag 1 -screen 2",
  -- "slack -tag 2 -screen 3"
  -- },
  ...
  wallpaper = papers[math.random(#papers)],
  -- "/.config/awesome/src/assets/fuji.jpg",
